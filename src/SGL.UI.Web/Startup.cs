...
using SGL.Infrastructure.UoW;
using SGL.ApplicationCore.Services;
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(options =>
                options.UseSqlServer(
                    Configuration.GetConnectionString("strConexaoSGL")));
                        services.AddDefaultIdentity<IdentityUser>()
                            .AddDefaultUI(UIFramework.Bootstrap4)
                            .AddEntityFrameworkStores<ApplicationDbContext>();

            services.AddDbContext<SGLContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("strConexaoSGL")));
